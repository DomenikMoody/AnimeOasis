...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('external_api_id', models.CharField(max_length=500, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            model_name='user',
            name='favorite_show',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.anime'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
